...
public class FollowerConstants {
    ...
    private static final double xMovement = 59;
    private static final double yMovement = 48.5;
    ...
    public static double translationalPIDFFeedForward = 0.012;
    ...
    public static double drivePIDFFeedForward = 0.008;
    ...
    public static double mass = 8.35;
    ...
    public static double forwardZeroPowerAcceleration = -47.5;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -75;
