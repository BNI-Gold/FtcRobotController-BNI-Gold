package org.firstinspires.ftc.teamcode.Competition.IntoTheDeep.Gold10219.pedroPathing.localization.localizers;
...
import org.firstinspires.ftc.teamcode.Competition.IntoTheDeep.Gold10219.pedroPathing.localization.Matrix;
...
public class TwoWheelPinpointIMULocalizer extends Localizer {
    ...
    public TwoWheelPinpointIMULocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-6.75, 2.5, 0);
        ...
        forwardEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rear_left_motor"));
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "rear_right_motor"));
