...
//import org.firstinspires.ftc.teamcode.Competition.IntoTheDeep.Gold10219.Pathing.Utils.Pathing.EasyPath;
...
//                new Point(spikeMarkGoalPose.getX()
//                        + MathFunctions.getSign(scoreSpikeMarkMidPoint.getX() - spikeMarkGoalPose.getX())
//                        * Math.abs(scoreSpikeMarkMidPoint.getX() - spikeMarkGoalPose.getX())
//                        * ROBOT_FRONT_LENGTH / scoreSpikeMarkMidToSpikeDistance,
//                spikeMarkGoalPose.getY()
//                        + MathFunctions.getSign(scoreSpikeMarkMidPoint.getY() - spikeMarkGoalPose.getY())
...
//                    scoreSpikeMark.setLinearHeadingInterpolation(
//                            startPose.getHeading()
//                                    - 0.1
//                                    * MathFunctions.getTurnDirection(
//                                            startPose.getHeading(),
//                                            scoreSpikeMark.getEndTangent().getTheta()
//                                    )
...
//                            scoreSpikeMark.getEndTangent().getTheta());
//
//                    //Using Mitchell's SafeInterpolationStartHeading
////                    scoreSpikeMark.setLinearHeadingInterpolation(
////                            new SafeInterpolationStartHeading(
////                                    startPose,
////                                    scoreSpikeMark
////                            ).getValue(),
////                            scoreSpikeMark.getEndTangent().getTheta()
